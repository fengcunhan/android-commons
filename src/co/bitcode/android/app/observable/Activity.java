...
/**
 * An {@link android.app.Activity} which implements the Observable pattern for certain life-cycle
 * events.
 * 
 * @since 1.0.0
 * @author Lorenzo Villani
 */
public class Activity extends android.app.Activity implements ObservableActivity {
